...
<body>
   ...
   $sql = "INSERT INTO Дні_відправлення(Номер_потягу, Номер_маршруту, День_відправлення, Час_відправлення, Час_прибуття, Тривалість_маршруту, Перелік_зупинок) VALUES($номер_потягу, $номер_маршруту, '$день_відправлення', '$час_відправлення', '$час_прибуття', '$тривалість_маршруту', $перелік_зупинок);";
