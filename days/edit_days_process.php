...
<body>
   ...
   $sql = "UPDATE Дні_відправлення SET Номер_потягу = $номер_потягу, Номер_маршруту = $номер_маршруту, 
           День_відправлення='$день_відправлення', Час_відправлення='$час_відправлення', Час_прибуття='$час_прибуття', Тривалість_маршруту='$тривалість_маршруту', Перелік_зупинок=$перелік_зупинок, Ціна=$ціна WHERE id=$id;";
